  ...
  return (
    <div className="flex flex-col mt-3 mx-auto gap-5">
      <address className="bg-slate-100 shadow-lg rounded-xl border p-6 w-full sm:w-2/3 md:w-1/2 mx-auto">
        ...
        <div className="text-lg text-gray-600 mb-2 flex items-center gap-2 font-semibold">
        ...
        <div className="text-lg text-gray-600 mb-4 flex items-center gap-2 font-semibold">
